    ...
    methods: {
        ...
        async postData(e) {
            ...
            const Response = await axios({
                method: 'POST',
                url: 'https://rentvent.store/api/my_properties_detail.php?id=' + this.rowId,
                data: {
                    id: this.rowId,
            ...
            const Response2 = await axios({
                method: 'POST',
                url: 'https://rentvent.store/api/tenent_details.php?id=' + this.rowId,
                data: {
                }
            })
            ...
            const Output = await axios({
                method: 'POST',
                url: 'https://rentvent.store/api/tenent_shop_details.php?id=' + this.rowId,
                data: {
                }
            })
            ...
            Response2.data.forEach(async function myfunc (x) {
                ...
                if (diffDays > 5) {
                    const SendData = await axios({
                        method: 'post',
                        url: 'https://rentvent.store/api/rent_reminder_mail.php',
                        data: {
                            userEmail: Uemail,
        ...
        async getAmount() {
            const Response3 = await axios({
                method: 'post',
                url: 'https://rentvent.store/api/tenent_details.php',
                data: {
                    prop_id: this.rowId,
                }
            });
        ...
        async deleteTenent(tid) {
            ...
            if (confirm('Do you really want to delete this data ?')) {
                const Response3 = await axios({
                    method: 'post',
                    url: 'https://rentvent.store/api/delete_tenentr.php',
                    data: {
                        tenentId: tid,
                    }
                });
